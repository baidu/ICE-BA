...
cmd="./bin/ice_ba --imgs_folder $EuRoC_PATH/MH_01_easy --start_idx 0 --end_idx -1 --iba_param_path config/param.txt  --gba_camera_save_path $EuRoC_PATH/result/MH_01_easy.txt"
echo $cmd
eval $cmd
